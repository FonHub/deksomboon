  ...
  <div class="page-wrapper">
    ...
    <main class="page-main">
      <ul class="uk-breadcrumb listing-breadcrumb">
        ...
        <li><a href="#">ผลิตภัณฑ์ทั้งหมด</a></li>
        <li><a href="#">ซีอิ๊วขาว</a></li>
        <li class="uk-disabled"><a>ซีอิ๊วขาวสูตร 1 </a></li>
      </ul>
      <!-- icon category -->
      ...
      <div class="uk-container-expand block-color  pb-xl-40">
        <!-- product -->
        <div class="uk-grid uk-padding-large" data-uk-grid>
            ...
            <div class="uk-position-relative">
              <div class="uk-h3 b-title news-goods__title uk-flexbox">
                <div class="uk-flex uk-flex-left">
                  <div class="text__header">ซีอิ๋วขาว สูตร 1</div>
                </div>
              </div>
              <div class="best-seller">
                <ul class="uk-grid uk-grid-medium uk-child-width-1-2@s uk-child-width-1-5@m">
                  ...
                  <li class="pb-20">
                    <?php include('item-card-color_soldout.php'); ?>
                  </li>
                  <li class="pb-20">
                    <?php include('item-card-color_soldout.php'); ?>
                  </li>
