    ...
    <main class="page-main">
      <div class="section-banner">
        <ul class="uk-breadcrumb listing-breadcrumb">
          ...
          <li class="uk-disabled"><a>hot hit item</a></li>
        </ul>
      </div>
      <!--  -->
      <div class="page-content block-color">
        <div class="uk-container uk-container-large">
          <div class="section-hot-hit-item">
            <div class="">
              <div class="uk-margin-small">
                <!-- item list -->
                <div class="uk-h3 b-title hot-hit-item__title uk-flexbox">
                  <div class="uk-flex uk-flex-left">
                    <div class="text__header hotitem">hot hit item </div>
                    <img class="h-100" src="../assets/img/img-title/hothit-item-title.png" alt="" />
                  </div>
                  <div>
                    <h4 class="uk-title__seeall"></h4>
                  </div>
                </div>
                <div class="uk-position-relative">
                  <div class="hot-hit-list">
                    <ul class="uk-grid uk-grid-small uk-child-width-1-2@s uk-child-width-1-3@m uk-child-width-1-4@l uk-child-width-1-5@xl">
