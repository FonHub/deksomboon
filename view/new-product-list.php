    ...
    <main class="page-main">
      <div class="section-banner">
        <ul class="uk-breadcrumb listing-breadcrumb">
          ...
          <li class="uk-disabled"><a>สินค้าใหม่</a></li>
        </ul>
      </div>
      <!-- -->
              ...
              <div class="uk-margin-medium">
                ...
                <div class="uk-h3 b-title news-goods__title uk-flexbox">
                  <div class="uk-flex uk-flex-left">
                    <div class="text__header text__hcolor">สินค้าใหม่</div>
                    <img class="h-100" src="../assets/img/img-title/news-goods-titel.png" alt="" />
                  </div>
                  <div>
                ...
                <div class="uk-position-relative">
                  <div class="new-product-list">
                    <ul class="uk-grid uk-grid-small uk-child-width-1-2@s uk-child-width-1-3@m uk-child-width-1-4@l uk-child-width-1-5@xl">
                      <li>
                        <?php include('item-card-color_dark.php'); ?>
                      </li>
                      <li>
                        <?php include('item-card-color_dark.php'); ?>
                      </li>
                      <li>
                        <?php include('item-card-color_green.php'); ?>
                      </li>
                      <li>
                        <?php include('item-card-color_green.php'); ?>
                      </li>
