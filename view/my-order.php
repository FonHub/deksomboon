                    ...
                    <div class="uk-width-2-3@m">
                      <div class="uk-margin">
                        ...
                        <div class="uk-child-width-1-1@xl">
                          <label for="inputAddressOne" class="label">
                            ข้อมูลที่อยู่จัดส่ง
                          </label>
                          <input id="inputAddressOne" type="text" name="inputAddressOne" maxlength="200" placeholder="กรอกข้อมูลที่อยู่" class="uk-input input-address-one">
                        </div>
                        <div class="uk-child-width-1-1@xl">
                          <label for="inputAddressTwo" class="label">ข้อมูลใบกำกับภาษี</label>
                          <input id="inputAddressTwo" type="text" name="inputAddressTwo" maxlength="200" placeholder="กรอกข้อมูลที่อยู่" class="uk-input input-address-one">
                        </div>
                        <div class="uk-margin">
                          <div class="uk-grid uk-grid-medium uk-child-width-1-2@xl" uk-grid>
                            <div>
